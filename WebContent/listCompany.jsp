        ...
        <tbody>
            <c:forEach items="${companies}" var="company">
                <tr>
                    ...
                    <td><fmt:formatDate pattern="yyyy-MMM-dd" value="${company.registrationDate}" /></td>
                    ...
                    <td><c:out value="${company.officeAddress}" /></td>
                    <td><c:out value="${company.subCategory}" /></td>
                    <td><a href="CompanyController?action=edit&companyId=<c:out value="${company.id}"/>">Update</a></td>
                    <td><a href="CompanyController?action=delete&companyId=<c:out value="${company.id}"/>">Delete</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
    <p><a href="CompanyController?action=insert">Add Company</a></p>
    <p><a href="CompanyController?action=import">Import from CSV</a></p>
</body>
</html>